...
<<<<<<< HEAD
            ...
            "description": "Architecting and developing core features across CRM, Partner Management, and website platforms at Factori.com (Sushine Exports Private Limited). Spearheading the frontend migration from legacy AdminLTE/Bootstrap to React.js, optimizing SQL queries and page performance, and integrating modern AI-accelerated workflows using Cursor AI, ChatGPT, and Claude.",
            "skills": "React.js, CRM Systems, Partner Management, SQL Query Optimization, AdminLTE Migration, Bootstrap, Cursor AI, ChatGPT, Claude, JavaScript, Full Stack Web Development",
            "occupationLocation": {
              "@type": "AdministrativeArea",
              "name": "Bangalore, India"
            },
            "responsibilities": [
              "Engineered core modules for CRM, Partner Management portals, and primary website platforms at Factori.com",
              "Led frontend modernisation by migrating legacy AdminLTE and Bootstrap UI components to a modular React architecture",
              "Optimized SQL queries, database indexing, and frontend rendering performance to accelerate page load times",
              "Integrated AI-assisted engineering tools (Cursor AI, ChatGPT, Claude) to streamline code quality, refactoring, and delivery cycles"
            ]
          },
          {
            "@type": "Occupation",
