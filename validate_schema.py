...
schema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "primaryImageOfPage": {
        "@type": "ImageObject",
        "url": "https://sankara25.github.io/sankarasubramanian.dev/sankara_subramanian.png",
        "caption": "Sankara Subramanian – Senior Full Stack Developer"
      },
      "inLanguage": "en-US",
    ...
    },
    {
      ...
      "worksFor": [
        {
          "@type": "EmployeeRole",
          "roleName": "AI-Powered Full Stack Engineer",
          "startDate": "2025-06",
          "employer": {
            "@type": "Organization",
      ...
      "hasOccupation": [
        {
          ...
          "skills": "Backend Development, Frontend Development, REST APIs, Microservices, System Architecture, Database Optimization, AI Automation, Cloud Engineering"
        }
      ],
      "knowsAbout": [
        "PHP",
...
# Fix position 5 ListItem in breadcrumb
schema["@graph"][2]["itemListElement"][4]["@type"] = "ListItem"

# Ensure valid json serialization
json_str = json.dumps(schema, indent=2)
json.loads(json_str)
print("Schema is valid JSON-LD!")
